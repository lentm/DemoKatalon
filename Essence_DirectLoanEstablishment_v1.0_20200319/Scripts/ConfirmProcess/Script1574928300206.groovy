...
println("a: " + GlobalVariable.sequence)
notificationPage.confirmDirectLoanEstablishment(GlobalVariable.testCaseID, GlobalVariable.results, GlobalVariable.sequence, loanRef, GlobalVariable.step)
